...
<body>
    <div class="navbar">
        ...
        <ul>
            ...
            <li><a href="#"><i class="fas fa-wallet"></i> My Transactions</a></li>
    ...
    <div class="content">
        <div class="profile-card">
            ...
            <div class="profile-info">
                <span>ID:</span> <b><%= c.getId() %></b>
            </div>
            <div class="profile-info">
                <span>Gender:</span> <b><%= c.getGender() %></b>
            </div>
            <div class="profile-info">
                <span>Email:</span> <b><%= c.getEmail() %></b>
            </div>
            <div class="profile-info">
                <span>Address:</span> <b><%= c.getAddress() %></b>
            </div>
            <div class="profile-info">
                <span>Contact:</span> <b><%= c.getContactno() %></b>
            </div>
            <div class="profile-info">
                <span>Yearly Income:</span> <b><%= c.getYearlyincome() %></b>
            </div>
