...
<head>
    ...
    <title>Donor Dashboard - SDP Project</title>
...
<body>
    ...
    <div class="navbar">
        ...
        <ul>
            ...
            <li><a href="#"><i class="fas fa-hand-holding-heart"></i> My Donations</a></li>
